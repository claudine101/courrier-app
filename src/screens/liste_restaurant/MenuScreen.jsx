...
export default function MenuScreen() {
          ...
          const { categorie, resto } = route.params
          ...
          const [selectedResto, setSelectedResto] = useState(resto)
                    ...
                    <>
                              ...
                              <View style={styles.container}>
                                        ...
                                        <ScrollView style={styles.cardOrginal} stickyHeaderIndices={[1]}>
                                                  ...
                                                  {(firstLoadingProducts || loadingProducts) ? <HomeProductsSkeletons wrap noTitle /> :
