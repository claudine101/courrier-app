...
export default function SearchAllLivreurScreen() {
          ...
          const voirDetails = () =>{
                navigation.navigate("NoHeaderSearchLivreurScreen", {commande:commande, serviceCategory:serviceCategory})
          }
                    ...
                    (async () => {
                              try {
                                ...
                                if(serviceCategory==1){
                                        ...
                                        var url=`/resto/restaurant_commandes/status_historiques/${commande.ID_COMMANDE}`
                                }
                                const stts= await fetchApi(url)
                                        // const stts = await fetchApi(`/ecommerce/ecommerce_commandes/status_historiques/${commande.ID_COMMANDE}`, {
                                        //           cacheData: false,
