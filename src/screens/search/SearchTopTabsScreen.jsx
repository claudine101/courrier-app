...
export default function SearchTopTabsScreen({ search, service }) {
          return (
                    ...
                    >
                              ...
                              <TopTab.Screen name="BoutiqueResearchScreen" component={BoutiqueResearchScreen} initialParams={{ search }} options={{ title: "Boutiques" }} />
                              <TopTab.Screen name="RestaurantResearchScreen" component={RestaurantResearchScreen} initialParams={{ search }} options={{ title: "Restaurants" }} />
                    </TopTab.Navigator>
          )
}
