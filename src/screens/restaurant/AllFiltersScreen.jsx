...
import CategorieModalizeMenuFiltres from "../../components/restaurants/AllMenu/CategorieModalizeMenuFiltres";
...
/**
 * Screens pour afficher les filtres par rapport des prix, categorie les plus cher, plus achettees et notes.... cote restauration 
...
export default function AllFiltersScreen() {
        ...
        useEffect(() => {
                (async () => {
                        try {
                                const allCategorie = await fetchApi('/resto/restaurant_menus/restaurant_categorie_menu')
