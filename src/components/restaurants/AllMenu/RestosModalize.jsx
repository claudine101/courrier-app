...
export default function RestosModalize({ restos, restosModalizeRef, selectedResto, setSelectedResto, loadingForm, setLoadingForm, loadingRestos, setIsRestoOpen }) {
        return (
                <Modalize
                        ...
                        /> :
                                <View style={styles.modalContainer}>
                                        <View style={styles.modalHeader}>
                                                <Text style={styles.modalTitle}>Les restaurants</Text>
