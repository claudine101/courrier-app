 ...
 */
export default function ProductRatings({ userRating, productId }) {
          const [loadingReviews, reviews] = useFetch(`/ecommerce/ecommerce_produits_notes?ID_PRODUIT=${productId}`)
