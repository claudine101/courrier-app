 ...
 */
export default function UserProductRating({ productId, userRating, scrollRef, SERVICE }) {
    ...
    const onSubmit = async () => {
        ...
        try {
            var url = "/ecommerce/ecommerce_produits_notes"
            if (SERVICE == IDS_SERVICE_CATEGORIES.resto) {
                url = "/resto/restaurant_menus_notes"
            }
            setLoading(true)
            const form = new FormData()
            form.append("COMMENTAIRE", data.commentaire)
            if (SERVICE == IDS_SERVICE_CATEGORIES.resto) {
                form.append("ID_RESTAURANT_MENU", productId)
        ...
        <View style={styles.container} onLayout={(event) => {
            ...
            {userRating ? <View>
                ...
                <View style={styles.actions}>
                    <TouchableOpacity onPress={() => navigation.navigate('EditRatingScreen', { userRating, SERVICE })} style={styles.actionBtn}>
