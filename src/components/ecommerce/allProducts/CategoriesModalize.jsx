...
export default function CategoriesModalize({ categories, categoriesModalizeRef, selectedCategory, setSelectedCategory, loadingForm, setLoadingForm, loadingCategories, setIsOpen }) {
          return (
                    <Modalize
