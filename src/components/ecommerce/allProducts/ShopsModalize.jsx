...
export default function ShopsModalize({ restos, restosModalizeRef, selectedResto, setSelectedResto, loadingForm, setLoadingForm, loadingRestos, isRestoOpen, setIsRestoOpen }) {
          return (
                    <Portal>
                              <GestureHandlerRootView style={{ height: isRestoOpen ? '100%' : 0, opacity: isRestoOpen ? 1 : 0, backgroundColor: 'rgba(0, 0, 0, 0)', position: 'absolute', width: '100%', zIndex: 1 }}>
                                        <Modalize
